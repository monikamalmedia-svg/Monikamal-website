...
export function Hero({ kicker, headline, subheadline, videoUrl }: HeroProps) {
  ...
  return (
    <section className="relative z-20 h-screen min-h-[650px] w-full max-h-[1080px] overflow-hidden bg-[#0d0509]">
      ...
      <p
        aria-hidden
        className="pointer-events-none absolute right-0 bottom-56 z-[15] select-none pr-4 text-right font-sans text-[11px] leading-none font-medium tracking-widest text-white/70 uppercase sm:pr-6 md:bottom-6"
      >
        {t("adWatermark")}
      </p>
